...
--
-- Host: localhost    Database: permanent
-- ------------------------------------------------------
...
--
-- Dumping events for database 'permanent'
--

--
-- Dumping routines for database 'permanent'
--
/*!50003 DROP PROCEDURE IF EXISTS `spuCrearBD` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `spuCrearBD`(IN pDbName VARCHAR(100))
BEGIN
...
-- Dump completed on 2017-08-03  9:52:34
