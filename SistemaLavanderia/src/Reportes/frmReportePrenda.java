 ...
 * @author Admin
 */
public class frmReportePrenda extends javax.swing.JFrame {

    /**
     * Creates new form frmReportePrenda
     */
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Reporte Prenda");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmReportePrenda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmReportePrenda().setVisible(true);
            }
        });
    }
