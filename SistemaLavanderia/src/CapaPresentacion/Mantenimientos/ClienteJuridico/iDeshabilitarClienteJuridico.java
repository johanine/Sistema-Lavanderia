 ...
 * @author joha
 */
public class iDeshabilitarClienteJuridico extends javax.swing.JInternalFrame {
    ...
    public iDeshabilitarClienteJuridico() {
        initComponents();
        ...
        try{
            ...
            for(int i=0; i<datos.length;i++){
                for(int j=0; j<datos[0].length;i++){
                    ...
                    if(titulos[j].toString().equals("RUC")){
                        datos_filtrados[i][1]= datos[i][j];
                    }
                    if(titulos[j].toString().equals("RazonSocial")){
