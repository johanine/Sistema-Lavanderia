 ...
 * @author joha
 */
public class iMostrarClientesJuridicos extends javax.swing.JInternalFrame {

    /**
     * Creates new form iMostrarClientes
     */
        cClienteJuridico oCliente ;
    int mensaje = 0;// 0 - error
    public iMostrarClientesJuridicos() {
        initComponents();
        oCliente= new cClienteJuridico();
