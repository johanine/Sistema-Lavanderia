 ...
 * @author joha
 */
public class iBuscarClienteJuridico extends javax.swing.JInternalFrame {
    ...
    public iBuscarClienteJuridico() {
        initComponents();
        CargarCombo(oCliente.getTitulos());
    ...
    private void CargarCombo(String[] titulos) {
        cmbCampo.removeAllItems();
        if(titulos.length>0){
            for(int i=0; i<titulos.length;i++){
                cmbCampo.addItem(titulos[i]);
            }
        }
    }
